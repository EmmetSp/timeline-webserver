var TL = function(t) {
    ...
    class Vt { // TimelineConfig
        ...
        addEvent(t, e) {
            ...
            return void 0 === t.start_date ? (O("Missing start date, skipping event"), console.log(t), null) : (this._processDates(t), this._tidyFields(t), this.events.push(t), this.event_dict[i] = t, this.displayed_ids[i] = this.events.length, e || Pt(this.events), i)
        }        
